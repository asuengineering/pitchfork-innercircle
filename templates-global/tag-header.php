...
<div id="tag-hero" class="container py-6">
	<div class="row">
        <div class="col-md-8    ">
            <?php 
            ...
            if( $link ) {
                ...
                ?>
                <a class="btn btn-maroon btn-md" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
            <?php } ?>
        </div>
